...
def featurize(config_path: Text) -> None:
    ...
    model_a_path = os.path.join('../model_a', config.base.dir_models, config.featurize.dependencies.model_a)
    ...
    model_b_path = os.path.join('../model_b', config.base.dir_models, config.featurize.dependencies.model_b)
